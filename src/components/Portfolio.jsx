      ...
      <div className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
        <div className="flex flex-col w-full lg:w-[45%] xl:w-[40%] lg:gap-5 xl:gap-7 gap-7">
          ...
          <p className="max-w-md text-gray-700 font-montserrat">
              É por isso que temos orgulho em oferecer uma ampla seleção de nossas luminárias de teto, parede, chão e mesa projetadas por designers. Você também encontrará produtos que variam de estilos modernos a interpretações modernas de design clássico. Nossa coleção é atualizada todos os dias com soluções belíssimas e estamos felizes que você é nosso cliente.
          </p>
